...
\end{mathpar}
\note{I think the \textsc{s-concat} rule might be messed up. To guarantee semantic safety (yet to be proven, of course), we might need it to replace the $S_2$ and $T_2$ supertypes in the premise with some $U=\textsf{glb}(S_2, T_2)$.}
